...
var titleOutput = document.getElementById("result");
...
titleField.addEventListener("input", function(){titleOutput.innerHTML=titleField.value;console.log("refreshed title")
});
directorField.addEventListener("input", function(){directorOutput.appendChild=directorField.value;console.log("refreshed director")
});
